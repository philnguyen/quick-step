...
(define-judgment-form Λ
  ...
  [(((if e_1 e_2 ρ) φ ... αₖ) (e              ρ) σ σₖ . ↓ . Σ)
   -------------------------------------------------------------------"E-If"
   ((               φ ... αₖ) ((if e e_1 e_2) ρ) σ σₖ . ↓ . Σ)]

  [(((ar e_2 ρ) φ ... αₖ) (e_1       ρ) σ σₖ . ↓ . Σ)
   -------------------------------------------------------------------"E-App"
   ((           φ ... αₖ) ((e_1 e_2) ρ) σ σₖ . ↓ . Σ)]

  [(((set! (@ ρ x)) φ ... αₖ) (e ρ)          σ σₖ . ↓ . Σ)
   -------------------------------------------------------------------"E-Set!"
   ((               φ ... αₖ) ((set! x e) ρ) σ σₖ . ↓ . Σ)]
  )
